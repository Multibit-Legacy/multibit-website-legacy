 ...
 */
@Path("/hd0.2")
public class PublicHD0_2Resource extends BaseResource {
  ...
  public Response getHelpImage(
    ...
    InputStream is = PublicPageResource.class.getResourceAsStream("/assets/images/en/hd0_2/"+image);
  ...
  public Response getDefaultLanguageHelpContents() {
    ...
    String resourcePath = "/" + ENGLISH + "/help/hd0.2/contents.html";
  ...
  public Response getDefaultLanguageHelpPage(
    ...
    // Java6 uses StringBuilder to optimise this
    String resourcePath = "/" + ENGLISH + "/help/hd0.2/" + page + ".html";
  ...
  public Response getLanguageSpecificHelpPage(
    ...
    // Java6 uses StringBuilder to optimise this
    String resourcePath = "/" + lang + "/help/hd0.2/" + pathParam;
