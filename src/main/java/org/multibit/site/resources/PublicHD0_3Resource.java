 ...
 */
@Path("/hd0.3")
public class PublicHD0_3Resource extends BaseResource {
  ...
  public Response getHelpImage(
    ...
    InputStream is = PublicPageResource.class.getResourceAsStream("/assets/images/en/hd0_3/"+image);
  ...
  public Response getDefaultLanguageHelpContents() {
    ...
    String resourcePath = "/" + ENGLISH + "/help/hd0.3/contents.html";
  ...
  public Response getDefaultLanguageHelpPage(
    ...
    // Java6 uses StringBuilder to optimise this
    String resourcePath = "/" + ENGLISH + "/help/hd0.3/" + page + ".html";
  ...
  public Response getLanguageSpecificHelpPage(
    ...
    // Java6 uses StringBuilder to optimise this
    String resourcePath = "/" + lang + "/help/hd0.3/" + pathParam;
