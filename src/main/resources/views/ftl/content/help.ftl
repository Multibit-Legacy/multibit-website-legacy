...
<div id="container3">
      ...
      <#if alertText??>
        ...
        <hr/>
          <p>Problem solved! How can I thank you?<br/>MultiBit is "donation-ware" and all <a href="bitcoin:1AhN6rPdrMuKBGFDKR1k9A8SCLYaNgXhty?amount=0.01&label=Please%20donate%20to%20multibit.org">donations</a> go towards development and server costs.</p>
