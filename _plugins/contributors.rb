...
module Jekyll
	...
	class CategoryGenerator < Generator
		def fetch_contributors
			contributors = JSON.parse(open("https://api.github.com/repos/jim618/multibit/contributors").read)
		...
		def generate(site)
			...
			@primary_devs = JSON.parse(open("https://api.github.com/repos/jim618/multibit/collaborators").read)
